...
export function CreativePreview({
  ...
  return (
    ...
    >
      <div className="absolute inset-0" style={{ backgroundColor: backgroundColor || "#0f172a", opacity: 0.55 }} />
      <div className="relative z-10 p-3 text-white max-w-[95%]">
        ...
        {subheadline && <p className="text-xs text-white/80 mt-1 line-clamp-2">{subheadline}</p>}
        {cta && (
          <span
