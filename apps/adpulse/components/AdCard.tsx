...
export function AdCard({ ad, userId, category }: { ad: ServedAd; userId: string; category: string }) {
      ...
      <div className="relative h-[55%] bg-slate-100">
        {img ? (
          ...
          <div
            ...
            style={{ backgroundSize: "cover", backgroundColor: ad.background_color || "#0f172a" }}
          >
